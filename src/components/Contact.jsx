...
const Contact = () => {
    ...
    // Delay Spline loading until component is in view or after initial render
    useEffect(() => {
        const timer = setTimeout(() => {
            setLoadSpline(true);
        }, 500); // Load Spline 500ms after component mounts
    ...
    return (
        <section id="Contact" className="py-24 px-4 relative bg-secondary/30 overflow-hidden">
            {/* Spline background with lazy loading */}
            {loadSpline && (
                <motion.div
                    initial={{ opacity: 0 }}
                ...
                >
                    <Suspense fallback={
                        <div className="absolute inset-0 bg-gradient-to-br from-secondary/50 to-background/50 animate-pulse" />
                    }>
                        <Spline 
                            scene="/world.spline"
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://maps.app.goo.gl/m8MuRrDfxEDEY7z1A" className="text-primary-foreground hover:text-primary">
